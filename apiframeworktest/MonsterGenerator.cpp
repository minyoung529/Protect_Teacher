...
MonsterGenerator::MonsterGenerator()
{
	...
	m_monsterDatas.push_back(MonsterData{ L"ÀÌ¹Î¿µ", 2,  /*ResMgr::GetInst()->ImgLoad(L"LEE", L"Image\\redbrick.bmp")*/ nullptr });
	m_monsterDatas.push_back(MonsterData{ L"±èµ¿À±", 10, /*ResMgr::GetInst()->ImgLoad(L"DONG", L"Image\\dongyun.bmp")*/ nullptr });
	m_monsterDatas.push_back(MonsterData{ L"°­´ëÈñ", 1, /*ResMgr::GetInst()->ImgLoad(L"KANG", L"Image\\daehee.bmp") */ nullptr});
	m_monsterDatas.push_back(MonsterData{ L"³²¼ÒÁ¤", 1, /*ResMgr::GetInst()->ImgLoad(L"NAM", L"Image\\sojeong.bmp") */ nullptr});
